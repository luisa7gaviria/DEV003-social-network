import {
  exit, addPost, deletePost, updatePosts, editPost,
} from '../lib/functions';
    ...
    if (fbResponse) {
      ...
      <div class="postBox">
       <div class="postContent">
         <h2 class="postTitle"> ${fbResponse.User} </h2>
         <p> ${fbResponse.Descripcion} </p>
         <span class="actTime"> ${fbResponse.Time} </span>
        </div>
      </div>
      ...
      if (auth.currentUser.uid !== fbResponse.User) {
